...
QT_MOC_LITERAL(4, 29, 12), // "ImgSrcSignal"
QT_MOC_LITERAL(5, 42, 7), // "InfoVec"
QT_MOC_LITERAL(6, 50, 13), // "getInfoMation"
QT_MOC_LITERAL(7, 64, 16), // "QVector<QString>"
QT_MOC_LITERAL(8, 81, 22), // "on_registerBtn_clicked"
QT_MOC_LITERAL(9, 104, 18) // "on_logoBtn_clicked"

    },
    "Register\0sendInfo\0\0infoJason\0ImgSrcSignal\0"
    "InfoVec\0getInfoMation\0QVector<QString>\0"
    "on_registerBtn_clicked\0on_logoBtn_clicked"
};
...
void Register::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->ImgSrcSignal((*reinterpret_cast< QJsonObject(*)>(_a[1]))); break;
        case 2: { QVector<QString> _r = _t->getInfoMation();
            if (_a[0]) *reinterpret_cast< QVector<QString>*>(_a[0]) = std::move(_r); }  break;
        case 3: _t->on_registerBtn_clicked(); break;
        case 4: _t->on_logoBtn_clicked(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Register::sendInfo)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Register::*_t)(QJsonObject );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Register::ImgSrcSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Register::ImgSrcSignal(QJsonObject _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
