...
QT_MOC_LITERAL(4, 19, 7), // "labelId"
QT_MOC_LITERAL(5, 27, 3), // "seq"
QT_MOC_LITERAL(6, 31, 9), // "productId"
QT_MOC_LITERAL(7, 41, 3) // "add"

    },
    "myButton\0click\0\0id\0labelId\0seq\0productId\0"
    "add"
};
...
static const uint qt_meta_data_myButton[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::Int, QMetaType::Int, QMetaType::Int, QMetaType::QString, QMetaType::Bool,    3,    4,    5,    6,    7,
...
void myButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->click((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< QString(*)>(_a[4])),(*reinterpret_cast< bool(*)>(_a[5]))); break;
        default: ;
        }
        ...
        {
            typedef void (myButton::*_t)(int , int , int , QString , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&myButton::click)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void myButton::click(int _t1, int _t2, int _t3, QString _t4, bool _t5)
{
