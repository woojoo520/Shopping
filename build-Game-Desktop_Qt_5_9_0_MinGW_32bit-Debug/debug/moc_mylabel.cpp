...
QT_MOC_LITERAL(3, 17, 3), // "tag"
QT_MOC_LITERAL(4, 21, 9), // "productId"
QT_MOC_LITERAL(5, 31, 5), // "showC"
QT_MOC_LITERAL(6, 37, 11), // "commentInfo"
QT_MOC_LITERAL(7, 49, 11) // "showComment"

    },
    "Mylabel\0clicked\0\0tag\0productId\0showC\0"
    "commentInfo\0showComment"
};
...
void Mylabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->showC((*reinterpret_cast< QJsonArray(*)>(_a[1]))); break;
        ...
        {
            typedef void (Mylabel::*_t)(int , QString );
        ...
        {
            typedef void (Mylabel::*_t)(QJsonArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Mylabel::showC)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Mylabel::clicked(int _t1, QString _t2)
{
...
// SIGNAL 1
void Mylabel::showC(QJsonArray _t1)
{
